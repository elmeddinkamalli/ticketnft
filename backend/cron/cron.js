...
cron.schedule("* * * * *", async (req, res) => {
  ...
  await cronTasks.getCreatedEvents(req, res, process.env.BNB_MAINNET_CHAIN_ID);
  ...
  await cronTasks.getCreatedTickets(req, res, process.env.BNB_MAINNET_CHAIN_ID);
  ...
  await cronTasks.getBurningTickets(req, res, process.env.BNB_MAINNET_CHAIN_ID);
